...
import (
	...
	storage "github.com/coinbase/rosetta-cli/internal/storage"
...
// ExpectedOperations provides a mock function with given fields: _a0, _a1, _a2, _a3
func (_m *Helper) ExpectedOperations(_a0 []*types.Operation, _a1 []*types.Operation, _a2 bool, _a3 bool) error {
	ret := _m.Called(_a0, _a1, _a2, _a3)

	var r0 error
	if rf, ok := ret.Get(0).(func([]*types.Operation, []*types.Operation, bool, bool) error); ok {
		r0 = rf(_a0, _a1, _a2, _a3)
	} else {
		r0 = ret.Error(0)
	}
...
// ExpectedSigners provides a mock function with given fields: _a0, _a1
func (_m *Helper) ExpectedSigners(_a0 []*types.SigningPayload, _a1 []string) error {
	ret := _m.Called(_a0, _a1)

	var r0 error
	if rf, ok := ret.Get(0).(func([]*types.SigningPayload, []string) error); ok {
		r0 = rf(_a0, _a1)
	} else {
		r0 = ret.Error(0)
	}
